...
export const ProjectData = [
    ...
    },
    {
        "id":"Prj6",
        "title":"Pokemon Info",
        "content":"This is simple pokemon info web site by clicking on the list of pokemon, users of the React web application can see the specifics of the various pokemon.",
